...
# Also note that pytsk3 is packaged as app-forensics/pytsk.
...
DEPEND="
	...
	>=dev-python/dfdatetime-20211113
	>=app-forensics/dfvfs-20220414
	...
	>=app-forensics/libesedb-20150409[python]
	>=app-forensics/libevt-20191104[python]
	>=app-forensics/libevtx-20210424[python]
	...
	>=app-forensics/liblnk-20150830[python]
	...
	>=dev-python/redis-py-3.4
	redis? ( <dev-python/redis-py-4.2 )
