...
EGO_SUM=(
	...
	"github.com/badgerodon/peg v0.0.0-20130729175151-9e5f7f4d07ca/go.mod"
	...
	"github.com/caffix/eventbus v0.0.0-20210522041342-56248842ee62/go.mod"
	"github.com/caffix/netmap v0.0.0-20210608001100-88b18a6c45e6"
	"github.com/caffix/netmap v0.0.0-20210608001100-88b18a6c45e6/go.mod"
	"github.com/caffix/netmap v0.0.0-20210713232424-345ed04dd495"
	"github.com/caffix/netmap v0.0.0-20210713232424-345ed04dd495/go.mod"
	"github.com/caffix/netmap v0.0.0-20210715165045-3ed7a4527a3d"
	"github.com/caffix/netmap v0.0.0-20210715165045-3ed7a4527a3d/go.mod"
	"github.com/caffix/pipeline v0.0.0-20210522041607-d06330c4484a"
	"github.com/caffix/pipeline v0.0.0-20210522041607-d06330c4484a/go.mod"
	"github.com/caffix/queue v0.0.0-20210420232735-50705a598e3e"
	"github.com/caffix/queue v0.0.0-20210420232735-50705a598e3e/go.mod"
	"github.com/caffix/resolve v0.0.0-20210608001200-208b45a02ad0"
	"github.com/caffix/resolve v0.0.0-20210608001200-208b45a02ad0/go.mod"
	"github.com/caffix/resolve v0.0.0-20210713232312-b68cd71e4a53"
	"github.com/caffix/resolve v0.0.0-20210713232312-b68cd71e4a53/go.mod"
	"github.com/caffix/service v0.0.0-20210522041423-4707edf94ff2"
	"github.com/caffix/service v0.0.0-20210522041423-4707edf94ff2/go.mod"
	"github.com/caffix/stringset v0.0.0-20201218015502-4f60634ff035/go.mod"
	"github.com/caffix/stringset v0.0.0-20210420232605-81a3d140a6a2"
	"github.com/caffix/stringset v0.0.0-20210420232605-81a3d140a6a2/go.mod"
	...
	"github.com/cayleygraph/cayley v0.7.7-0.20210618132536-7ef662d4c347/go.mod"
	"github.com/cayleygraph/cayley v0.7.7"
	"github.com/cayleygraph/cayley v0.7.7/go.mod"
	"github.com/cayleygraph/quad v1.1.0/go.mod"
	"github.com/cayleygraph/quad v1.2.4"
	"github.com/cayleygraph/quad v1.2.4/go.mod"
	...
	"github.com/chromedp/cdproto v0.0.0-20210508221054-d7cfa85db7d1/go.mod"
	...
	"github.com/chromedp/cdproto v0.0.0-20210706234513-2bc298e8be7f/go.mod"
	"github.com/chromedp/chromedp v0.7.2"
	"github.com/chromedp/chromedp v0.7.2/go.mod"
	...
	"github.com/cjoudrey/gluaurl v0.0.0-20161028222611-31cbb9bef199/go.mod"
	"github.com/clbanning/x2j v0.0.0-20191024224557-825249438eec/go.mod"
	"github.com/client9/misspell v0.3.4/go.mod"
	"github.com/cloudflare/cloudflare-go v0.17.0"
	"github.com/cloudflare/cloudflare-go v0.17.0/go.mod"
	"github.com/cloudflare/cloudflare-go v0.18.0"
	"github.com/cloudflare/cloudflare-go v0.18.0/go.mod"
	...
	"github.com/cznic/mathutil v0.0.0-20170313102836-1447ad269d64/go.mod"
	...
	"github.com/dennwc/base v1.0.0/go.mod"
	"github.com/dennwc/graphql v0.0.0-20180603144102-12cfed44bc5d/go.mod"
	"github.com/dghubble/go-twitter v0.0.0-20201011215211-4b180d0cc78d"
	"github.com/dghubble/go-twitter v0.0.0-20201011215211-4b180d0cc78d/go.mod"
	"github.com/dghubble/go-twitter v0.0.0-20210609183100-2fdbf421508e"
	"github.com/dghubble/go-twitter v0.0.0-20210609183100-2fdbf421508e/go.mod"
	"github.com/dghubble/sling v1.3.0"
	"github.com/dghubble/sling v1.3.0/go.mod"
	"github.com/dgraph-io/badger v1.5.4/go.mod"
	"github.com/dgraph-io/badger v1.5.5/go.mod"
	"github.com/dgrijalva/jwt-go v3.2.0+incompatible/go.mod"
	"github.com/dgryski/go-farm v0.0.0-20190416075124-e1214b5e05dc/go.mod"
	"github.com/dgryski/go-farm v0.0.0-20190423205320-6a90982ecee2/go.mod"
	"github.com/dgryski/go-sip13 v0.0.0-20181026042036-e10d5fee7954/go.mod"
	"github.com/dlclark/regexp2 v1.1.4"
	"github.com/dlclark/regexp2 v1.1.4/go.mod"
	"github.com/docker/docker v0.7.3-0.20180412203414-a422774e593b"
	"github.com/docker/docker v0.7.3-0.20180412203414-a422774e593b/go.mod"
	...
	"github.com/dop251/goja v0.0.0-20190105122144-6d5bf35058fa/go.mod"
	...
	"github.com/flimzy/diff v0.1.5/go.mod"
	"github.com/flimzy/diff v0.1.6/go.mod"
	"github.com/flimzy/kivik v1.8.1/go.mod"
	"github.com/flimzy/testy v0.1.16/go.mod"
	...
	"github.com/fsouza/go-dockerclient v1.2.2/go.mod"
	"github.com/geziyor/geziyor v0.0.0-20210530074354-d3bdaf624012"
	"github.com/geziyor/geziyor v0.0.0-20210530074354-d3bdaf624012/go.mod"
	...
	"github.com/go-kivik/couchdb v1.8.1/go.mod"
	"github.com/go-kivik/kivik v1.8.1/go.mod"
	"github.com/go-kivik/kiviktest v1.1.2/go.mod"
	"github.com/go-kivik/pouchdb v1.3.5/go.mod"
	...
	"github.com/gobuffalo/logger v1.0.4/go.mod"
	...
	"github.com/gobwas/ws v1.1.0-rc.6"
	"github.com/gobwas/ws v1.1.0-rc.6/go.mod"
	...
	"github.com/gopherjs/jsbuiltin v0.0.0-20180426082241-50091555e127/go.mod"
	...
	"github.com/hidal-go/hidalgo v0.0.0-20190814174001-42e03f3b5eaa/go.mod"
	"github.com/hidal-go/hidalgo v0.0.0-20201109092204-05749a6d73df"
	"github.com/hidal-go/hidalgo v0.0.0-20201109092204-05749a6d73df/go.mod"
	...
	"github.com/linkeddata/gojsonld v0.0.0-20170418210642-4f5db6791326/go.mod"
	...
	"github.com/mailru/easyjson v0.0.0-20190403194419-1ea4449da983/go.mod"
	...
	"github.com/opencontainers/selinux v1.0.0/go.mod"
	...
	"github.com/piprate/json-gold v0.3.0/go.mod"
	...
	"github.com/prometheus/procfs v0.7.0/go.mod"
	...
	"github.com/tylertreat/BoomFilters v0.0.0-20181028192813-611b3dbe80e8/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.0.4/go.mod"
	...
	"golang.org/x/sys v0.0.0-20190614160838-b47fdc937951/go.mod"
	...
	"golang.org/x/sys v0.0.0-20191009170203-06d7bd2c5f4f/go.mod"
	...
	"gopkg.in/olivere/elastic.v5 v5.0.81/go.mod"
	...
	"layeh.com/gopher-json v0.0.0-20201124131017-552bb3c4c3bf/go.mod"
