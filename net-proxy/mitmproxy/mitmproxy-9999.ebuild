...
RDEPEND="
	...
	>=dev-python/cryptography-2.0[${PYTHON_USEDEP}] <dev-python/cryptography-2.1
	...
	>=dev-python/ldap3-2.2.0[${PYTHON_USEDEP}] <dev-python/ldap3-2.4
	>=dev-python/passlib-1.6.5[${PYTHON_USEDEP}] <dev-python/passlib-1.8
	>=dev-python/pyasn1-0.3.1[${PYTHON_USEDEP}] <dev-python/pyasn1-0.4
	>=dev-python/pyopenssl-17.2[${PYTHON_USEDEP}] <dev-python/pyopenssl-17.3
	...
	examples? ( >=dev-python/pillow-3.2[${PYTHON_USEDEP}] <dev-python/pillow-4.3
