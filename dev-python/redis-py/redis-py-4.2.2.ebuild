...
# This is a copy of the Gentoo main repository ebuild, made because app-forensics/plaso
# has an upper limit on the redis-py version it supports.
...
python_test() {
	local EPYTEST_DESELECT=(
		...
		# These try to connect to port 6380 and fail for some reason...?
