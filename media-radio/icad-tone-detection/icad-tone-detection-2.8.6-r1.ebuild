...
src_prepare() {
	chmod 755 src/icad_tone_detection/bin/macos_arm64/icad_decode
	chmod 755 src/icad_tone_detection/bin/linux_x86_64/icad_decode
	chmod 755 src/icad_tone_detection/bin/linux_arm64/icad_decode
