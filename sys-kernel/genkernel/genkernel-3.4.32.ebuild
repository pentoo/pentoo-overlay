...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.4.32.ebuild,v 1.1 2012/05/14 00:20:53 sping Exp $
...
src_unpack() {
	...
	use pentoo && cd "${S}"
	use pentoo && epatch "${FILESDIR}"/aufs-changes-e2fsprogs-2.diff
}
