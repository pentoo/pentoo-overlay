...
SRC_URI="http://pentoo-uefi.googlecode.com/files/${PN^^}_LINUX_DRIVER_v${PV^^}_SOURCE.tar.bz2"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"

S="${WORKDIR}/${PN^^}_LINUX_DRIVER_v$(get_version_component_range 1-3)_SOURCE"
