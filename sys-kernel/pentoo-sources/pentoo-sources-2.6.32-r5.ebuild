...
HARDENED_SRC="hardened-patches-${PV}-7.extras.tar.bz2"
HARDENED_URI="http://dev.gentoo.org/~anarchy/dist/${HARDENED_SRC}"
...
4420_grsecurity-2.1.14-2.6.32.9-201002231820.patch \
...
4515_reiser4-grsec.patch"
	else
		 UNIPATCH_EXCLUDE="${UNIPATCH_EXCLUDE} 4315_reiser4.patch"
	fi
