...
GITLAB_PREF="gitlab.arm.com/api/v4/projects/tooling%2Fgnu-toolchains-for-arm/packages/generic/gnu-toolchain"
SRC_URI="amd64? ( https://${GITLAB_PREF}/${MY_PV2}/arm-gnu-toolchain-${MY_PV2}-x86_64-arm-none-eabi.tar.xz )
	arm64? ( https://${GITLAB_PREF}/${MY_PV2}/arm-gnu-toolchain-${MY_PV2}-aarch64-arm-none-eabi.tar.xz )"
